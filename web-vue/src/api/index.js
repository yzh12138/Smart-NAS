...
export const getProvincePhotoStats = () => request.get('/api/photo/map/provinces')
export const getPhotosByProvince = (province) => request.get(`/api/photo/map/province/${encodeURIComponent(province)}`)
